...
sites:
	# cd find_sites && python find_sites_long.py ../../infiles/miR_Family_info_sample.txt ../../outfiles/bins_tiny_outfile.txt ../../infiles/UTR_Sequences_sample.txt ../../outfiles/sites_tiny_outfile.txt
	# cd find_sites && python find_sites_long.py ../../infiles/kathy_seed_file.txt ../../outfiles/bins_small_outfile.txt ../../infiles/tiny_utrs.txt ../../outfiles/sites_small_outfile.txt
	cd find_sites && python find_sites_long.py ../../infiles/kathy_seed_file.txt ../../outfiles/bins_big_outfile.txt ../../infiles/UTR_Sequences_Ensembl_forTS_kathy_no_header.txt ../../outfiles/sites_big_outfile.txt
